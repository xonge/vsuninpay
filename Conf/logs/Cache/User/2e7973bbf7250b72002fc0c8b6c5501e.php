	  ...
	  <form class="form" method="post" action="" enctype="multipart/form-data">	 
		<table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%">
			<tbody>
				<tr>
					<th width="120">人名　　：</th>
					<td><input type="text" name="username"class="px" style="width:550px;"></td>
				</tr>
				<tr>
					<th>头像　　：</th>
					<td><input type="text" name="headpic" id="headpic" class="px" style="width:550px;">   <script src="/tpl/static/upyun.js?<?php echo date('YmdHis',time());?>"></script><a href="###" onclick="upyunPicUpload('headpic',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('headpic')">预览</a></td>
				</tr>
				<tr>
					<th width="120">身份　　：</th>
					<td><input type="text" name="position" class="px" style="width:550px;"></td>
				</tr>
				<tr>
					<th width="120">介绍　　：</th>
					<td><textarea style="width:550px;height:75px" name="synopsis" id="synopsis" class="px"></textarea><br/></td>
				</tr>
				<th>&nbsp;</th>
					<td>
