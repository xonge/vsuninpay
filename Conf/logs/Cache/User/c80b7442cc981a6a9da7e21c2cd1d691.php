	  ...
	  <form class="form" method="post" action="" target="_top" enctype="multipart/form-data">	 
		<table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%">
			<tbody>
							...
							<div class="hidden" id="weixin_setting">
								<div class="setting_rows">
									...
									<div id="new_wxpay_box" class="wxpay_box" <?php if($config['weixin']['is_old']): ?>style="display:none;"<?php endif; ?>>
										...
										<p><span>Mchid：</span><input type="text" name="weixin[mchid]" value="<?php echo ($config["weixin"]["mchid"]); ?>" class="px" />&nbsp;&nbsp;商户号</p>
										<p><span>Key：</span><input type="text" name="weixin[key]" value="<?php echo ($config["weixin"]["key"]); ?>" class="px" />&nbsp;&nbsp;商户支付密钥Key</p>
										<p><span>Appsecret：</span><input type="text" name="weixin[appsecret]" value="<?php echo ($config["weixin"]["appsecret"]); ?>" class="px" />&nbsp;&nbsp;JSAPI接口中获取openid</p>
									</div>
				...
				<tr>
					<th><img src="<?php echo ($staticPath); ?>/tpl/static/pay_icon/tenpay.png"/>财付通(即时到帐)：</th>
					<td>
						<div class="pay_setting">
							<div>
								<input type="radio" name="tenpayComputer[open]" id="open_tenpaycomputer_yes" value="1" <?php if($config['tenpayComputer']['open'] == 1): ?>checked="checked"<?php endif; ?>/>&nbsp;<label for="open_tenpaycomputer_yes">开启</label>&nbsp;&nbsp;&nbsp;&nbsp;
								<input type="radio" name="tenpayComputer[open]" id="open_tenpaycomputer_no" value="0" <?php if($config['tenpayComputer']['open'] == 0): ?>checked="checked"<?php endif; ?>/>&nbsp;<label for="open_tenpaycomputer_no">关闭</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<a href="###" onclick="showSetting('tenpaycomputer','财付通(即时到帐)');" class="a_choose">配置信息</a>
							</div>
							<div class="hidden" id="tenpaycomputer_setting">
								<div class="setting_rows">
									<p><span>partnerId：</span><input type="text" name="tenpayComputer[partnerid]" value="<?php echo ($config["tenpayComputer"]["partnerid"]); ?>" class="px" /></p>
									<p><span>partnerKey：</span><input type="text" name="tenpayComputer[partnerkey]" value="<?php echo ($config["tenpayComputer"]["partnerkey"]); ?>" class="px" /></p>
								</div>
							</div>
						</div>
					</td>
						...
						<td>
							<div class="pay_setting">
								...
								<div class="hidden" id="platform_setting">
									<div class="setting_rows">
										<p><span>名称标注：</span><input type="text" name="platform[platformName]" value="<?php echo ($config["platform"]["platformName"]); ?>" class="px" />&nbsp;&nbsp;支付时的支付名称额外的标注【如：<font color="red">支付宝(小猪)</font>】，不填写则不展示</p>
									</div>
								</div>
							</div>
						</td>
