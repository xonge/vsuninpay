		...
		<table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%">
			<tbody>
				<tr>
				  ...
				  <td>
					<span class="red">http://<?php echo $_SERVER['HTTP_HOST'] ?>/index.php?g=Wap&a=index&token=<?php echo ($token); ?>&wecha_id={wechat_id}</span></td>
				</tr>
				<tr>
				...
				<TR>
                  ...
                  <TD><input type="text" class="px" id="gzhurl"  name="gzhurl" value="<?php echo ($home["gzhurl"]); ?>" style="width:580px;"  /><br>
                    <span class="red">填写此链接地址可以有效帮助粉丝关注您的公众号！请填写一个微信官方公众平台群发出的文章链接。</span>
                  </TD>
                </TR>
				<tr>
					<th>3G网站背景：</th>
