...
th,td{text-align: -webkit-left;font-size:12px;}
	...
	<table border="0" cellpadding="0" cellspacing="0" width="100%">
		...
		<tr bgcolor="#F1F1F1">
			...
			<td>
				<div class="mr15 l">
                <a href="http://bbs.5214.com.cn/forum.php?mod=viewthread&tid=158&extra=page%3D1" target="_blank" title="也可百度：emoji表情代码">菜单图标码</a>
                <input id="emoji_code" class="txt" name="emoji_code" title="主菜单前小图标" size="8" value="<?php echo ($show["emoji_code"]); ?>" type="text">
