...
<div class="tab">
<ul>
<?php if($ischild != 1): ?><li class="tabli" id="tab0"><a href="<?php echo U('Repast/company_index', array('token' => $token,'cid' => $cid));?>">餐厅管理</a></li><?php endif; ?>
...
<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tablelist): $mod = ($i % 2 );++$i;?><tr>
        ...
        <td><?php echo $Companys_arr[$tablelist['cid']];?></td>
