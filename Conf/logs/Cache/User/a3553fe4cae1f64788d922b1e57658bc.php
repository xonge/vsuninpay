		...
		<table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%">
			<tbody>
				<tr>
				  ...
				  <td><span class="red">吃粽子 —— 当用户输入该关键词时，将会触发此回复。</span></td>
				</tr>
				<tr>
                ...
                <tr>
					<th>首页粽子图片：</th>
					<td><input type="text" name="zz" value="<?php echo ($set["zz"]); ?>" id="zz" class="px" style="width:550px;"> <script src="/tpl/static/upyun.js"></script><a href="#" onclick="upyunPicUpload('zz',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="#" onclick="viewImg('zz')">预览</a>   &nbsp; <a href="/tpl/Wap/default/common/czz/images/c4.png">下载图标模板</a></td>
				</tr>
                <tr>
					<th>关注微信的图标：</th>
					<td><input type="text" name="wx" value="<?php echo ($set["wx"]); ?>" id="wx" class="px" style="width:550px;"> <script src="/tpl/static/upyun.js"></script><a href="#" onclick="upyunPicUpload('wx',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="#" onclick="viewImg('wx')">预览</a>   &nbsp; <a href="/tpl/Wap/default/common/czz/images/c18.png">下载图标模板</a></td>
				</tr>
                 <TR>
