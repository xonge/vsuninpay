		...
		<div class="device">
			...
			<div style="cursor: grab;"  class="swiper-container">
				<div style="width: 6720px; height: 205px; transform: translate3d(-1680px, 0px, 0px); transition-duration: 0s;" class="swiper-wrapper">
				 <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($i%6 == 1): ?><div style="width: 1680px; height: 205px;" class="swiper-slide swiper-slide-visible swiper-slide-active">
