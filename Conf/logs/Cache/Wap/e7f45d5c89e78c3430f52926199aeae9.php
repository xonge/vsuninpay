...
<div class="content">
	...
	<?php if($wecha_id != ''): ?><div id="zjl" <?php if($Guajiang['usenums'] != 2): ?>style="display:none"<?php endif; ?> class="boxcontent boxwhite">
		<div class="box">
            ...
            <input name=""  class="px" id="tel" value="<?php echo ($fans["tel"]); ?>" type="text" placeholder="请输入您的<?php echo ($Guajiang["renametel"]); ?>">
            <input name=""  class="px" id="wechaname" value="<?php echo ($fans["wxid"]); ?>" type="text" placeholder="请输入您的微信号">
