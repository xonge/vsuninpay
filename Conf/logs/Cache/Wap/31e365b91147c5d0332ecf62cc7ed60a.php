...
window.shareData = {  
            ...
            "timeLineLink": "<?php echo ($f_siteUrl); echo U('Live/index',array('token'=>$token,'id'=>$live_info['id']));?>",
            "sendFriendLink": "<?php echo ($f_siteUrl); echo U('Live/index',array('token'=>$token,'id'=>$live_info['id']));?>",
            "weiboLink": "<?php echo ($f_siteUrl); echo U('Live/index',array('token'=>$token,'id'=>$live_info['id']));?>",
