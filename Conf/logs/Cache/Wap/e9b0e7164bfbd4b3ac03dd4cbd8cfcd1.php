...
<head>
  ...
  <link href="<?php echo RES;?>/gamet/style/main.css" rel="stylesheet" type="text/css">
  <link rel="shortcut icon" href="<?php echo RES;?>/gamet/favicon.ico">
  <link rel="apple-touch-icon" href="<?php echo RES;?>/gamet/apple-touch-icon.png">
...
<body>
  ...
  <script src="<?php echo RES;?>/gamet/js/animframe_polyfill.js"></script>
  <script src="<?php echo RES;?>/gamet/js/keyboard_input_manager.js"></script>
  <script src="<?php echo RES;?>/gamet/js/html_actuator.js"></script>
  <script src="<?php echo RES;?>/gamet/js/grid.js"></script>
  <script src="<?php echo RES;?>/gamet/js/tile.js"></script>
  <script src="<?php echo RES;?>/gamet/js/local_score_manager.js"></script>
  <script src="<?php echo RES;?>/gamet/js/game_manager.js"></script>
  <script src="<?php echo RES;?>/gamet/js/application.js"></script>
...
function DrawImage(ImgD,_width,_height){   
 ...
 <script>
  document.addEventListener('WeixinJSBridgeReady', function onBridgeReady() {
        window.shareData = {  
            "imgUrl": "<?php echo ($f_siteUrl); ?>/tpl/Wap/default/common/img/2048/2048t.png",
            "timeLineLink": '<?php echo ($f_siteUrl); ?>/index.php?g=Wap&m=Gamet&a=index&token=<?php echo ($_GET['token']); ?>&wecha_id=<?php echo ($_GET['wecha_id']); ?>',
            "sendFriendLink":'<?php echo ($f_siteUrl); ?>/index.php?g=Wap&m=Gamet&a=index&token=<?php echo ($_GET['token']); ?>&wecha_id=<?php echo ($_GET['wecha_id']); ?>',
            "weiboLink": '<?php echo ($f_siteUrl); ?>/index.php?g=Wap&m=Gamet&a=index&token=<?php echo ($_GET['token']); ?>&wecha_id=<?php echo ($_GET['wecha_id']); ?>',
            "tTitle": "2048加强版",
