...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		/>
		<link href="./tpl/static/tpl/1273/css/cate.css" rel="stylesheet" type="text/css"
		/>
		<style>
		</style>
...
<div class="device">
			...
			<div class="swiper-container">
                ...
                <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($i%8 == 1): ?><div class="swiper-slide">
                   <div class="content-slide"><?php endif; ?>
						...
						<?php if($i%8== 0 || $i == count($info) ): ?></div></div><?php endif; endforeach; endif; else: echo "" ;endif; ?>
				</div>
