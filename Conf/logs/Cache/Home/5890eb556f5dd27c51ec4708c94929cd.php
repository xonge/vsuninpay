...
<div class="topNavBox">
  <div class="topNavCenterBox"><img width="140" height="40" src="<?php echo ($f_logo); ?>">
    <ul class="nav">
      ...
      <?php if($_SESSION['uid']==false): ?><li class="login"><a href="/dl.php">代理登录</a></li>
        <li class="login"><a href="<?php echo U('Index/login');?>">用户登录</a></li>
...
<div id="masterWrap" class="masterWrap">
  <div class="masterBox">
    <div class="masterText">
      ...
      <div class="dn-link"> <a href="<?php echo ($f_siteUrl); ?>/static/app/muyoukj.zip"><span>下载安卓客户端</span></a> </div>
    </div>
    <div class="masterAni">
      <div class="lineWrap">
      ...
      <div class="personWrap">
        <div class="personBox"> <img style="display: inline-block; margin-top: 10px; margin-left: 10px; width: 40px; height: 40px; opacity: 1; " title="木友" src="<?php echo RES;?>/images/person.png"> </div>
      </div>
...
<div class="footer">
  <div class="footerCenter">
    <div class="footerLink">
      ...
      <a class="ftext" href="<?php echo ($f_siteUrl); ?>/#">关于我们</a> &nbsp;&nbsp;<a target="_blank" class="ftext" href="/">开放平台</a> &nbsp;&nbsp;<a target="_blank" class="ftext" href="<?php echo U('Home/Index/help');?>">使用帮助</a> &nbsp;&nbsp;<a class="ftext" href="">©2013-2014 <?php echo ($f_siteName); ?> </a> </div>
  
    <div class="footerContact">
      <div class="contactItem">
        <div class="ciIcon"><i class="fa fa-comments-o"></i></div>
        <div class="ciText"><a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=<?php echo ($f_kfqq); ?>&site=qq&menu=yes">QQ <?php echo ($f_qq); ?></a><br>
          <span>点击在线交流</span></div>
      </div>
      <div class="contactItem">
        <div class="ciIcon"><i class="fa fa-envelope-o"></i></div>
        <div class="ciText"><a href="mailto:aiweixin@126.com" target="_blank" title="发送邮件给我们"><!--邮件地址--></a><br></div>
      </div>
      <div class="contactItem">
        <div class="ciIcon"><i class="fa fa-phone"></i></div>
        <div class="ciText" style="padding-top:4px;"> <!--电话--> </div>
      </div>
    </div>
    <div class="footerWeixin">
      <h1 style="padding-bottom:9px;"><?php echo ($f_siteName); ?>科技</h1>
      <div><img src="/tpl/Home/bbs52jscncom/common/images/ewm2.jpg"></div>
    </div>
  </div>
</div>
</body>
