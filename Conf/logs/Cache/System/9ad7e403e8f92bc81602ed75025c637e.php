...
<table width="100%" border="0" cellspacing="0" cellpadding="0" id="addn">
	<form id="myform" action="<?php echo U('Site/insert');?>" method="post">
		...
		<tr> 
			...
			<td>
				<input type="text" name="tenpay_partnerid" value="<?php echo C('tenpay_partnerid');?>" class="ipt" size="45" />
				<span>&nbsp;&nbsp;(仅选择财付通时填写)</span>
			</td>
		</tr>
		<tr> 
			...
			<td>
				<input type="text" name="tenpay_partnerkey" value="<?php echo C('tenpay_partnerkey');?>" class="ipt" size="45" />
				<span>&nbsp;&nbsp;(仅选择财付通时填写)</span>
			</td>
		</tr>
		<tr> 
			...
			<td>
				<input type="text" name="alipay_name" value="<?php echo C('alipay_name');?>" class="ipt" size="45" />
				<span>&nbsp;&nbsp;例：phpw_CN@163.COM(仅选择支付宝时填写)</span>
			</td>
		</tr>
		<tr> 
			<td  height="48" align="right"><strong>支付宝PID：</strong></td>
			<td>
				<input type="text" name="alipay_pid" value="<?php echo C('alipay_pid');?>" class="ipt" size="45" />
				<span>&nbsp;&nbsp;请登陆支付宝商家服务中去查看(仅选择支付宝时填写)</span>
			</td>
		</tr>
		<tr> 
			<td  height="48" align="right"><strong>支付宝KEY：</strong></td>
			<td>
				<input type="text" name="alipay_key" value="<?php echo C('alipay_key');?>" class="ipt" size="45" />
				<span>&nbsp;&nbsp;请登陆支付宝商家服务中去查看(仅选择支付宝时填写)</span>
			</td>
		</tr>
