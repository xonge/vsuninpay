...
class Wxauth2Action extends BaseAction {
    //高级功能-》开发者模式-》获取
    ...
    function __construct() {
        $this->app_id = 'wxb959b9317dd0b640';
    }
...
//            $redirect_url = 'http://union.suninpay.com/wap/index.php?ctl=register';
        ...
        $this->app_id = 'wxb959b9317dd0b640';
        $wx['appid'] = 'wxb959b9317dd0b640';

        $wx['authorize_url'] = 'https://open.weixin.qq.com/connect/oauth2/authorize?appid=' . $wx['appid'] . '&redirect_uri=' . urlencode($redirect_url) . '&response_type=code&scope=snsapi_base&state=123#wechat_redirect';
...
//            return json_decode($token_data[1], true);
            ...
            $url = 'http://v.suninpay.com/index.php?g=Wap&m=Red_packet&a=chaikai&token=wfzqmi1427969786&id=1';
            header('Location:' . $url);
        }
